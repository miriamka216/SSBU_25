...
1: Pri použití pearsonovho korelačného koeficientu je najvyššia negatívna korelácia medzi premennými Bin.7.66 a Bin.0.86, koeficient korelácie je -0.761.
2: Využitím T-testu som zistila, že na hladine významnosti p=0,0001 je 44 vzoriek štatisticky významných, čo naznačuje, že medzi skúmanými skupinami pre tieto vzorky existuje významný rozdiel.
3: Pri využití spermanovej metriky a následne algoritmu zhlukovania prostredníctvom Ward’s linkage výsledný dendogram ukázal, že dáta sú rozdelené do 2 skupín - pacienti a kontroly. V časti s kontrolali došlo k jemnému prekryvu pacientov, ale vetva pacientov je čistá. 
4: Využitím PCA analýzy som zistila, že PC1 a PC2 do značnej miery rozdeľujú pacientov od kontrol a ostatné PC3–PC5 nie su moc významné, ale môžu pomôcť nájsť podskupiny alebo výnimočné vzorky.
